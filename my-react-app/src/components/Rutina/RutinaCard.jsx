...
const RutinaCard = ({ rutina, onEliminarRutina, NombreAlumno }) => {
  ...
  const handleEditClick = async (diaId) => {
    try {
        const response = await fetch(`http://localhost:5000/api/dias/${diaId}/ejercicios`);
...
const handleGuardarEditEjercicio = async () => {
  try {
    ...
    const deletePromises = ejerciciosAEliminar.map(idEjercicio =>
      fetch(`http://localhost:5000/api/ejercicios/${idEjercicio}`, {
        method: 'DELETE',
      })
    );
      ...
      <div style={{display:'flex', justifyContent:'space-between', alignItems:'center'}}>
        <div style={{margin: '10px' }}>
          ...
          <div style={{display:'flex'}}>
              ...
              <img className='svg-icon small' src="./src/assets/add.svg" alt="+Día" />
            ...
            <Button variant="btn btn-sm btn-outline-secondary" 
              ...
              >
                <SVGComponent src="./src/assets/close.svg" color="#c3c5c9"/>
            </Button>
          </div>
      </div>
      <ul>
                ...
                <div style={{display:'flex', justifyContent:'space-between'}}>
                    ...
                    <div style={{display:'flex'}}>
                      <Button className="btn btn-sm btn-warning custom-svg-btn" 
                        ...
                        <img className='svg-icon small' src="./src/assets/add.svg" alt="add" />
                        <img className='' src="./src/assets/exercise.svg" alt="exercise" />
                      </Button>
                      ...
                      <Button  variant="btn btn-sm btn-outline-danger" onClick={() => handleConfirmDeleteDia(dia.IdDia)}
                        style={{
                          ...
                          <SVGComponent src="./src/assets/close.svg" color="#111827"/>
                      </Button>
                    </div>
            ...
            <Form key={ejercicio.IdEjercicio} style={{ padding: '10px' }}>
              ...
              <div style={{display:'flex', justifyContent:'flex-end'}}>
                  <Button variant='btn primary'
                    ...
                    <SVGComponent src="./src/assets/close.svg" color="#909090" />
                  </Button>
                </div>
